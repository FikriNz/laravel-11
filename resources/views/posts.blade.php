<x-layout>
    ...
    <section class="dark:bg-gray-900 py-16 lg:pt-20 md:pt-10">
        <div class="py-8 my-4 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-0">
                        ...
                        <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                            <div class="relative w-full">
                                ...
                                <input
                                    ...
                                    placeholder="Enter article" type="search" id="search" name="search"
                                    autocomplete="off">
                            </div>
                            <div>
                                <button type="submit"
            ...
            <div class="grid gap-8 mx-auto md:grid-cols-2 lg:grid-cols-3">
                @forelse ($posts as $post)
                    <article
                        class="p-6 flex flex-col h-full bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <h2 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white"><a
